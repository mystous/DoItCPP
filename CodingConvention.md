...
## Naming Rule
본서에서 작성된 예제 소스 코드는 STL활용이 많기 때문에 STL Naming Rule을 따릅니다.

STL은 Naming Rule을 ***snake_case***를 사용합니다. 따라서 본서에서도 모든 예제 코드에서는 ***snake_case***를 사용합니다. 그리고 상수 매크로 등 C언어 규칙을 사용한 경우 ***SCREAMING_SNAKE_CASE***를 사용합니다.
### *snake_case*
